    ...
    <div class="reports-container">
      ...
      <div class="reports-grid">
        <div class="report-section">
          ...
          <mat-nav-list>
            <a mat-list-item routerLink="/reports/financial">
        ...
        <div class="report-section">
          <h3>Work reports</h3>
          <mat-nav-list>
            <a mat-list-item routerLink="/reports/work">
              <h4>Visits</h4>
        ...
        <div class="report-section">
          ...
          <mat-nav-list>
            <a mat-list-item routerLink="/reports/clients">
        ...
        <div class="report-section">
          ...
          <mat-nav-list>
            <a mat-list-item routerLink="/reports/expenses">
              <h4>Expenses</h4>
